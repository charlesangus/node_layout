...
layout_menu.addCommand("Sort By Filename", "sort_by_filename()", shortcutContext=2,)
layout_menu.addCommand("Select Upstream Ignoring Hidden", "select_upstream_ignoring_hidden()", "E", shortcutContext=2,)
...
layout_menu.addCommand("Make Room Left", "make_room.make_room(direction='left')", "{", shortcutContext=2,)
layout_menu.addCommand("Make Room Right", "make_room.make_room(direction='right')", "}", shortcutContext=2,)
